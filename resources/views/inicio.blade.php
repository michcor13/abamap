                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mt-5">
                            ...
                            <p class="body-2">Somos una empresa Mexicana comprometidos con la elaboracion de productos
                                ...
                                atendiendo de manera optima las necesidades y la demanda de nuestro mercado.
                            </p>
                            <h1 class="misvisval text-center">
                                Misión
                            </h1>

                            <p class="body-2">Comercializar materias primas para la industria alimenticia, con los mejores
                                precios y el mejor
                                servicio.</p>
                            <h1 class="misvisval text-center">
                                Visión
                            </h1>
                            <p class="body-2">busca ser una empresa lider en su ramo, continuando dando el mejor servicio y
                                satisfaccion a
                                nuestros clientes.</p>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item bg-transparent text-center">Integridad</li>
                                <li class="list-group-item bg-transparent text-center">Confiabilidad</li>
                                <li class="list-group-item bg-transparent text-center">Responsabilidad</li>
                                <li class="list-group-item bg-transparent text-center">Humildad</li>
